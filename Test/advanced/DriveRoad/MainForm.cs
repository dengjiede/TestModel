    ...
    public partial class MainForm : Form
    {
        ...
        private void init()
        {
            ...
            try
            {
                ...
                string tmpFDBPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\shp\road\road.shp");
        ...
        private void btnDriveModel_Click(object sender, System.EventArgs e)
        {
            try
            {
                if (polyline != null)
                {
                    ...
                    material.TextureName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\shp\road\textrure.jpg");
