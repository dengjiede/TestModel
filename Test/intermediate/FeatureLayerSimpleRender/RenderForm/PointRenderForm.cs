        ...
        public PointRenderForm(IGeometryRender geoRender, object[] fieldNamesItems, bool isSimplePoint)
        {
            ...
            if (render == null)
            {
                if (isSimplePoint)
                {
                    ...
                    string[] row11 = new string[] { "FillColor", tmpSymbol.FillColor.ToString("X") };                    
            ...
            if (isSimplePoint)
            {
                ...
                if (symbol != null)
                {
                    ...
                    string[] row11 = new string[] { "FillColor", symbol.FillColor.ToString("X") };                    
                    ...
                    case 1:
                        {
                            ...
                            if (this.colorDialog1.ShowDialog() == DialogResult.OK)
                            {
                                ...
                                this.dataGridView1.Rows[e.RowIndex].Cells[1].Value = olec.ToString("X");
                            }
                        }
                        break;
                    case 2:
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (IsSimplePoint)
            {
                ...
                if (this.dataGridView1.Rows[0].Cells[1].Value.ToString() != "")
                {
                    ...
                    newSymbol.FillColor = (uint)(col.A << 24 | col.R << 16 | col.G << 8 | col.B);
                }
