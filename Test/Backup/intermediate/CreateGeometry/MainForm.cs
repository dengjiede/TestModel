...
namespace CreateGeometry
{
    public partial class MainForm : Form
    {
        ...
        private void btnConstructTriMesh_Click(object sender, EventArgs e)
        {
            ...
            // TriMesh属性
            geo.DirectedEdgeCount = triMesh.get_DirectedEdgeCount();
            geo.FacetCount = triMesh.get_FacetCount();
            geo.VertexCount = triMesh.get_VertexCount();
        ...
        private void btnConstructClosedTriMesh_Click(object sender, EventArgs e)
        {
            ...
            string tmpFile = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\off");
            ...
            // TriMesh属性
            geo.DirectedEdgeCount = closedTriMesh.get_DirectedEdgeCount();
            geo.FacetCount = closedTriMesh.get_FacetCount();
            geo.VertexCount = closedTriMesh.get_VertexCount();
