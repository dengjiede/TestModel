...
namespace HelloWorld
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            {
                string tmpXMLPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\xml\CameraTour_1.xml");
            ...
            {
                string tmpXMLPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\xml\CameraTour_2.xml");
                tour = this.axRenderControl1.ObjectManager.CreateCameraTour(rootId);
                if (File.Exists(tmpXMLPath))
                {
                    StreamReader sr = new StreamReader(tmpXMLPath);
        ...
        {
            IRuntimeInfo ri = new RuntimeInfo();
            AboutDialog ab = new AboutDialog(ri.InstallDate, ri.Version);
            ab.ShowDialog();
        }
