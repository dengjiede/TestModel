                ...
                if (e.pickResult != null)
                {
                    if (e.pickResult.Type == gviObjectType.gviObjectFeatureLayer)
                    {
                        ...
                        if (this.tabControl1.SelectedIndex == 0)
                        {
                            ...
                            string imgPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\dds");
                            ...
                            //2、将模型及贴图写入osg文件
                            string modelName = string.Format(@"D:\{0}.osg", Guid.NewGuid().ToString());//输出osg文件路径
