    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            // 可视化Point类型FeatureLayer
            {
                ...
                string tmpFDBPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\point.FDB");
                ...
                textAttribute.TextColor = 0xff0000ff;
            ...
            // 可视化Polyline类型FeatureLayer
            {
                IConnectionInfo ci = new ConnectionInfo();
                ci.ConnectionType = gviConnectionType.gviConnectionFireBird2x;
                string tmpFDBPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\polyline.FDB");
                ci.Database = tmpFDBPath;
                ...
                geoSymbol.Color = 0xffff00ff;  //线颜色为Purple
                geoRender.Symbol = geoSymbol;
            ...
            // 可视化Polygon类型FeatureLayer
            {
                ...
                geoSymbol.Color = 0xffffff00;  //面填充色为Yellow
                geoRender.Symbol = geoSymbol;
            ...
            // 可视化ModelPoint类型FeatureLayer
            {
                IConnectionInfo ci = new ConnectionInfo();
                ci.ConnectionType = gviConnectionType.gviConnectionFireBird2x;
                string tmpFDBPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\community.FDB");
                ci.Database = tmpFDBPath;
                ...
                geoSymbol.Color = 0xffff0000;  //模型颜色为Red
