...
// HelloWorldCPlus.cpp : 定义应用程序的类行为。
//
...
// 唯一的一个 CHelloWorldCPlusApp 对象

CHelloWorldCPlusApp theApp;


// CHelloWorldCPlusApp 初始化
...
BOOL CHelloWorldCPlusApp::InitInstance()
{
    ...
    {
        AfxMessageBox(L"请不要随意更改SDK目录名", MB_ICONERROR, 0);
        return  FALSE;  // 此处直接退出，阻止主窗口显示
    }
