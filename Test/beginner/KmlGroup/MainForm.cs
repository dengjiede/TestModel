...
namespace KmlGroup
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            {
                // 创建KMLGroup
                string tmpKmlPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\kml+kmz\蒙山.kml");
                ...
                tmpKmlPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\kml+kmz\内流区诸河.kmz");
        ...
        private void toolStripButtonAddKMLGroup_Click(object sender, System.EventArgs e)
        {
            ...
            if (flag > -1)
            {
                od.InitialDirectory = Application.StartupPath.Substring(0, flag) + @"Samples\Media\kml+kmz";
            }
