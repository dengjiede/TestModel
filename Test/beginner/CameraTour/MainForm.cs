...
namespace CameraTour
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            // 注册播放事件
            this.axRenderControl1.RcCameraTourWaypointChanged += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcCameraTourWaypointChangedEventHandler(axRenderControl1_RcCameraTourWaypointChanged);
            this.axRenderControl1.RcCameraFlyFinished += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcCameraFlyFinishedEventHandler(axRenderControl1_RcCameraFlyFinished);
            // 注册输出视频事件
            this.axRenderControl1.RcVideoExportBegin += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcVideoExportBeginEventHandler(axRenderControl1_RcVideoExportBegin);
            this.axRenderControl1.RcVideoExporting += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcVideoExportingEventHandler(axRenderControl1_RcVideoExporting);
            this.axRenderControl1.RcVideoExportEnd += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcVideoExportEndEventHandler(axRenderControl1_RcVideoExportEnd);
        ...
        {
            Invoke(frameHandler, new object[]{frameIndex, refTime});  //由渲染线程转到主线程
        }

        private void FrameSyncCall(int frameIndex, double refTime)
        {
            //this.Text = "FrameIndex: " + frameIndex.ToString() + " RefTime: " + refTime.ToString();
        ...
        // 播放过程中
        void axRenderControl1_RcCameraTourWaypointChanged(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcCameraTourWaypointChangedEvent e)
        {
        ...
        // 播放结束
        void axRenderControl1_RcCameraFlyFinished(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcCameraFlyFinishedEvent e)
        {
        ...
        // 开始输出视频
        void axRenderControl1_RcVideoExportBegin(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcVideoExportBeginEvent e)
        {
        ...
        // 输出视频过程中
        void axRenderControl1_RcVideoExporting(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcVideoExportingEvent e)
        {
            processdlg.progressBar1.Value = Int16.Parse((100 * e.percentage).ToString());
            processdlg.label1.Text = (100 * e.percentage).ToString();
        }

        // 输出视频结束
        void axRenderControl1_RcVideoExportEnd(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcVideoExportEndEvent e)
        {
        ...
        private void btnImportFromXML_Click(object sender, EventArgs e)
        {
            ...
            if (flag > -1)
            {
                od.InitialDirectory = Application.StartupPath.Substring(0, flag) + @"Samples\Media\xml";
            }
        ...
        private void btnExportAsXML_Click(object sender, EventArgs e)
        {
            ...
            if (flag > -1)
            {
                sd.InitialDirectory = Application.StartupPath.Substring(0, flag) + @"Samples\Media\xml";
            }
        ...
        private void btnExportAsVideo_Click(object sender, EventArgs e)
        {
            if (tour != null && tour.WaypointsNumber > 2)
            {
                ...
                if (flag > -1)
                {
                    sd.InitialDirectory = Application.StartupPath.Substring(0, flag) + @"Samples\Media";
                }
                sd.RestoreDirectory = true;
                if (sd.ShowDialog() == DialogResult.OK)
                {
