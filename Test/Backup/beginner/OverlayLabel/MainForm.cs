...
namespace OverlayLabel
{
    public partial class MainForm : Form
    {
        ...
        {
            pic = this.axRenderControl1.Camera.ScreenToWorld(e.x, e.y, out point);
        ...
        {
            if (e.pickResult == null) return;
            IOverlayLabelPickResult pr = e.pickResult as IOverlayLabelPickResult;
            IOverlayLabel label = pr.OverlayLabel;
            this.Text = label.Text;
        }
        ...
        public MainForm()
        {
            ...
            string imageNamePath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\bmp\Tulips.bmp");
        ...
        private void linkLabel_ImageName_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (flag > -1)
            {
                od.InitialDirectory = Application.StartupPath.Substring(0, flag) + @"Samples\Media\bmp";
            }
