    ...
    public partial class MainForm : Form
    {
        ...
        void axRenderControl1_RcMouseClickSelect(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEvent e)
        {
            if (e.pickResult == null)
                return;
            if (e.pickResult.Type == gviObjectType.gviObjectRenderArrow)
            {
                IRenderArrowPickResult pr = e.pickResult as IRenderArrowPickResult;
                if (pr != null)
                {
                    pr.RenderArrow.Highlight(0xffff0000);
                }
            }
        }
