...
namespace CalculateTopOnTerrain
{
    ...
    public class CalculateTopBase : ICalculateTop
    {
        ...
        /// 点样式
        /// </summary>
        protected IPointSymbol _PointSymbol = new SimplePointSymbol() { FillColor = 0xFF0FF000 };

        /// <summary>
        /// 面样式
        /// </summary>
        protected ISurfaceSymbol _SurfaceSymbol = new SurfaceSymbol() { Color = 0x550000FF };

        /// <summary>
        /// 曲线样式
        /// </summary>
        protected ICurveSymbol _CurveSymbol = new CurveSymbol() { Color = 0xFF00FFA0 };
        ...
        public CalculateTopBase(Gvitech.CityMaker.Controls.AxRenderControl axRenderControl)
        {
        ...
        protected void DrawTableLabel(double x, double y, double z)
        {
            ...
            if (_TableLabel == null)
            {
                ...
                // 内容标题样式
                TextAttribute columeCapitalTextAttribute = new TextAttribute() { TextColor = 4278190080, OutlineColor = 4294967295, Font = "Calibri", TextSize = 15, Bold = true, MultilineJustification = gviMultilineJustification.gviMultilineCenter };
                _TableLabel.SetColumnTextAttribute(0, columeCapitalTextAttribute);

                // 内容值样式
                TextAttribute columeValueTextAttribute = new TextAttribute() { TextColor = 4278190080, OutlineColor = 16777215, Font = "Calibri", TextSize = 13, Bold = true, MultilineJustification = gviMultilineJustification.gviMultilineLeft };
                _TableLabel.SetColumnTextAttribute(1, columeValueTextAttribute);

                // 标题样式
                _TableLabel.TitleBackgroundColor = 2531320032;
                TextAttribute titleTextAttribute = new TextAttribute() { TextColor = 4278190080, OutlineColor = 4294967295, Font = "宋体", TextSize = 15, MultilineJustification = gviMultilineJustification.gviMultilineCenter, Bold = true, BackgroundColor = 2531320032 };
