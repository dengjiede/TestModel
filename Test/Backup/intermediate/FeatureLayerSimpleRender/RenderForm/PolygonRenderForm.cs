    ...
    public partial class PolygonRenderForm : Form
    {
        ...
        public PolygonRenderForm(IGeometryRender geoRender, object[] fieldNamesItems)
        {
            ...
            if (render == null || render.Symbol == null)
            {
                ...
                string[] row1 = new string[] { "Color", tmpSurfaceSymbol.Color.ToString("X") };
                ...
                string[] row6 = new string[] { "BoundaryColor", tmpCurveSymbol.Color.ToString("X") };
...

            {
                ...
                {
                    string[] row1 = new string[] { "Color", surfaceSymbol.Color.ToString("X") };
                    ...
                    string[] row6 = new string[] { "BoundaryColor", boundarySymbol.Color.ToString("X") };
                ...
                else
                {
                    ...
                    string[] row4 = new string[] { "RepeatLengthV", surfaceSymbol.RepeatLengthV.ToString() };
                    string[] row5 = new string[] { "Rotation", surfaceSymbol.Rotation.ToString() };
                    string[] row6 = new string[] { "BoundaryColor", boundarySymbolNew.Color.ToString("X") };
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (this.dataGridView2.Rows[0].Cells[1].Value.ToString() != "")
            {
                ...
                newSurfaceSymbol.Color = (uint)(col.A << 24 | col.R << 16 | col.G << 8 | col.B);
            }
            ...
            if (this.dataGridView2.Rows[5].Cells[1].Value.ToString() != "")
            {
                ...
                Color col = Utils.HexNumberToColor(colstr);
                newBoundarySymbol.Color = (uint)(col.A << 24 | col.R << 16 | col.G << 8 | col.B);
            }
        ...
        private void checkBoxSurface_CheckedChanged(object sender, EventArgs e)
        {
            if (this.checkBoxSurface.Checked)
            {
                ...
                int flag = flag = Application.StartupPath.LastIndexOf("Samples");
                if (flag > -1)
                {
                    dlg.InitialDirectory = Application.StartupPath.Substring(0, flag) + @"Samples\Media\png";
                }
