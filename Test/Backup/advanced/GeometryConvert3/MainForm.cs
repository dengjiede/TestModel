...
namespace GeometryConvert3
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            try
            {
                string osgPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\mdb+osg\Ground\00650100agc4001.osg");
                ...
                int nCount = imgs.Count;
                if (nCount > 0)                
                imgNames = imgs.GetAllKeys();
        ...
        {
            fde_polygon = e.geometry as IPolygon;
        }
