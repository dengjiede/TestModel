    ...
    public partial class MainForm : Form
    {
        ...
        {          
            ...
            try
            {
                ...
                string tmpFDBPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\MultiSpatialColumns.FDB");
        ...
        private void btnCreatLine_Click(object sender, EventArgs e)
        {
            ...
            g.HighlightHelper.SetRegion(null);
        ...
        void g_RcMouseClickSelect(IPickResult PickResult, IPoint IntersectPoint, gviModKeyMask Mask, gviMouseSelectMode EventSender)
        {
            ...
            if (renderPolyline == null)
            {
                ...
                renderPolyline.Symbol = new CurveSymbol() { Color = 0xffffff00, Width = 4 };
            }
        ...
        private IRenderPolygon DrawBufferPolygon(double distance)
        {
            ...
            g.HighlightHelper.SetRegion(bufferPolygon);
            ...
            {
                _RenderPolygon = g.ObjectManager.CreateRenderPolygon(bufferPolygon, _SurfaceSymbol, rootId);
                    ...
                    foreach (IRowBuffer r in list)
                    {
                        ...
                        if (geometryIndex != -1)
                        {
                            ...
                            if (hhh > h)
                            {
                                ...
                                //高亮显示违章建筑
                                g.FeatureManager.HighlightFeature(fc, hfid, 0xffff0000);
