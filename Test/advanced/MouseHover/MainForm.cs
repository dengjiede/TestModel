...
namespace MouseHover
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            g.MouseSelectObjectMask = gviMouseSelectObjectMask.gviSelectFeatureLayer;
            g.MouseSelectMode = gviMouseSelectMode.gviMouseSelectHover;
            g.RcMouseClickSelect += new _IRenderControlEvents_RcMouseClickSelectEventHandler(g_RcMouseClickSelect);

            {
                this.helpProvider1.SetShowHelp(this.axRenderControl1, true);
                this.helpProvider1.SetHelpString(this.axRenderControl1, "");
                this.helpProvider1.HelpNamespace = "MouseHover.html";
            }
        }
        ...
        private void showInfo(DataTable dt, IPoint location)
        {
            if (tableLabel != null)
            {
                g.ObjectManager.DeleteObject(tableLabel.Guid);
            }
            if (dt != null && dt.Rows.Count == 1)
            {
                int row = dt.Columns.Count;
                IObjectManager objManager = g.ObjectManager;
                ...
                //表头背景色
                tableLabel.TitleBackgroundColor = ColorHelper.ARGBToUint(255, 255, 255, 200);
                ...
                //表的背景色
                tableLabel.TableBackgroundColor = ColorHelper.ARGBToUint(200, 255, 255, 200);

                // 表头样式
                TextAttribute headerTextAttribute = new TextAttribute();
                headerTextAttribute.TextColor = ColorHelper.ARGBToUint(255, 0, 0, 0);
                ...
                contentTextAttribute.TextColor = ColorHelper.ARGBToUint(255, 0, 0, 0); ;
