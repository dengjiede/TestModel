...
namespace DynamicViewshed
{
    public partial class MainForm : Form
    {
        ...
        private void init()
        {
            ...
            string tmpTileLayerPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\sdk.tdb");
        ...
        public MainForm()
        {
            ...
            cbShowProjectionLines.Checked = tv.ShowProjectionLines;
            cbShowProjector.Checked = tv.ShowProjector;
        ...
        private void LoadDynamicObjectAndLineFromFile()
        {
            ...
            string tourPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\xml\CameraTour_2.xml");
        ...
        {
            string fileName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\x\Character\QiYeYuanGong.X");
            if (skinMesh == null)
            {
                // 构造ModelPoint
            ...
            if (tv == null)
            {
                ...
                tv.ShowProjectionLines = true;
                tv.ShowProjector = true;
        ...
        {
            if (tv != null)
                tv.ShowProjectionLines = cbShowProjectionLines.Checked;
        }

        private void cbShowProjector_CheckedChanged(object sender, EventArgs e)
        {
            if (tv != null)
                tv.ShowProjector = cbShowProjector.Checked;
        }
        #endregion
    }
}
