...
namespace MotionPath
{
    public partial class MainForm : Form
    {
        ...
        private void init()
        {
            ...
            string tmpTedPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\terrain\SingaporeGlobeTerrain.ted");
        ...
        private void LoadTableLabel()
        {
            ...
            dynamicTableLabel.BorderColor = ColorHelper.ARGBToUint(255, 255, 255, 255);
            dynamicTableLabel.BorderWidth = 2;
            dynamicTableLabel.TableBackgroundColor = ColorHelper.ARGBToUint(200, 255, 255, 165);
            dynamicTableLabel.TitleBackgroundColor = ColorHelper.ARGBToUint(180, 122, 122, 122);
        ...
        private void LoadParticleEffect()
        {
            if (particleEffect == null)
            {
                ...
                string fileName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\png\water.png");
                ...
                particleEffect.ParticleBirthColor = 0xffffffff;
                particleEffect.ParticleDeathColor = 0x00ffffff;
