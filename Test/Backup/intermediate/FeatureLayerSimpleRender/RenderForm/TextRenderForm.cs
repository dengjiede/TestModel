    ...
    public partial class TextRenderForm : Form
    {
        ...
        public TextRenderForm(ITextRender textRender)
        {
            ...
            if (render == null || render.Symbol == null)
            {
                ...
                string[] row1 = new string[] { "BackgroundColor", tmpAttribute.BackgroundColor.ToString("X") };
                ...
                string[] row6 = new string[] { "LineColor", tmpSymbol.LineColor.ToString("X") };
                ...
                string[] row12 = new string[] { "TextColor", tmpAttribute.TextColor.ToString("X") };
...

            {
                ...
                if (attribute != null)
                {
                    string[] row1 = new string[] { "BackgroundColor", attribute.BackgroundColor.ToString("X") };
                    ...
                    string[] row6 = new string[] { "LineColor", symbol.LineColor.ToString("X") };
                    ...
                    string[] row12 = new string[] { "TextColor", attribute.TextColor.ToString("X") };
                ...
                else
                {
                    ...
                    string[] row1 = new string[] { "BackgroundColor", attributeNew.BackgroundColor.ToString("X") };
                    ...
                    string[] row10 = new string[] { "PivotAlignment", symbol.PivotAlignment.ToString() };
                    string[] row11 = new string[] { "Priority", symbol.Priority.ToString() };
                    string[] row12 = new string[] { "TextColor", attributeNew.TextColor.ToString("X") };
                    ...
                    case 17:
                        {
                            ...
                            if (this.colorDialog1.ShowDialog() == DialogResult.OK)
                            {
                                ...
                                this.dataGridView2.Rows[e.RowIndex].Cells[1].Value = olec.ToString("X");
                            }
                        }
                        break;
                    case 1:
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (this.dataGridView2.Rows[0].Cells[1].Value.ToString() != "")
            {
                ...
                newAttribute.BackgroundColor = (uint)(col.A << 24 | col.R << 16 | col.G << 8 | col.B);
            }
            ...
            if (this.dataGridView2.Rows[5].Cells[1].Value.ToString() != "")
            {
                ...
                Color col = Utils.HexNumberToColor(colstr);
                newSymbol.LineColor = (uint)(col.A << 24 | col.R << 16 | col.G << 8 | col.B);
            }
            ...
            if (this.dataGridView2.Rows[11].Cells[1].Value.ToString() != "")
            {
                ...
                Color col = Utils.HexNumberToColor(colstr);
                newAttribute.TextColor = (uint)(col.A << 24 | col.R << 16 | col.G << 8 | col.B);
            }
            ...
            if (this.dataGridView2.Rows[17].Cells[1].Value.ToString() != "")
            {
                ...
                Color col = Utils.HexNumberToColor(colstr);
                newAttribute.OutlineColor = (uint)(col.A << 24 | col.R << 16 | col.G << 8 | col.B);
            }
