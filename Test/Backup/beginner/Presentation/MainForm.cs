...
namespace Presentation
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            //this.axRenderControl1.RcPresentationFlyToReachedDestination += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcPresentationFlyToReachedDestinationEventHandler(axRenderControl1_RcPresentationFlyToReachedDestination);
            ...
            this.axRenderControl1.RcPresentationStatusChanged += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcPresentationStatusChangedEventHandler(axRenderControl1_RcPresentationStatusChanged);
        ...
        void axRenderControl1_RcPresentationFlyToReachedDestination(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcPresentationFlyToReachedDestinationEvent e)
        {
            this.Text = e.step.Type.ToString();
        }

        void axRenderControl1_RcBeforePresentationItemActivation(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcBeforePresentationItemActivationEvent e)
        {
            this.Text = e.step.Type.ToString();
        }

        void axRenderControl1_RcPresentationStatusChanged(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcPresentationStatusChangedEvent e)
        {
            this.Text = e.status.ToString();
        }
        ...
        {
            // 加载直升飞机
            string fileName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\x\Vehicles\wrj.X");
            if (skinMeshPlane == null)
            {
                ...
                // 设置位置
                IMatrix matrix = new MatrixClass();
                matrix.MakeIdentity();
