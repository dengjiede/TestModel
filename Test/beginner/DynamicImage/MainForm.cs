        ...
        private void toolStripDynamicImage_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                switch (this.toolStripDynamicImage.SelectedIndex)
                {
                    ...
                    case 1:
                        {
                            imgpath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\frameImage\NiHongDeng");
                        }
                        break;
                    case 2:
                        {
                            imgpath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\frameImage\Gvitech");
                        }
                        break;
                }
