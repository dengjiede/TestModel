...
namespace DynamicBoard
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            // 加载仪表盘
            string modelNameBiaoPan = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\osg\Dashboard\yibiaopan.osg");
            ...
            // 加载指针
            string modelNameZhiZhen = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\osg\Dashboard\zhizhen.osg");
