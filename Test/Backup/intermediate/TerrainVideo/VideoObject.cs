...
namespace TerrainVideo
{
    public class VideoObject
    {
        ...
        private bool showProjectionLines;
        [Category("参数"), Description("是否显示放映机的投影射线")]
        public bool ShowProjectionLines
        {
            get
            {
                return showProjectionLines;
            }
            set
            {
                if (value != showProjectionLines)
                {
                    showProjectionLines = value;
                    NotifyPropertyChange("ShowProjectionLines");
                }
            }
        }

        private bool showProjector;
        [Category("参数"), Description("是否显示放映机")]
        public bool ShowProjector
        {
            get
            {
            ...
            set
            {
                if (value != showProjector)
                {
                    showProjector = value;
                    NotifyPropertyChange("ShowProjector");
                }
            }
        }
        ...
        public VideoObject()
        {
            ...
            Icon = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\png\camera.png");
            ...
            ShowProjector = false;
            VideoFileName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\video\ambulance.AVI");
            VideoLength = 0;
            VideoOpacity = 1.0;
            VideoPosition = 0;
        }
        ...
        public void Update()
        {
            try
            {
                ...
                tv.ShowProjectionLines = this.showProjectionLines;
                tv.ShowProjector = this.showProjector;
