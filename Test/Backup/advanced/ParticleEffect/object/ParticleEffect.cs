...
namespace ParticleEffect
{
    public class ParticleEffect
    {
        ...
        public ParticleEffect()
        {
            ...
            ImageName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\png\Partial.png");
        ...
        public virtual void Refresh()
        {
            try
            {
                ...
                particleEffect.ParticleBirthColor = ColorHelper.ColorToUint(ParticleBirthColor);
                particleEffect.ParticleDeathColor = ColorHelper.ColorToUint(ParticleDeathColor);
