...
namespace ParticleEffect
{
    public partial class MainForm : Form
    {
        ...
        {
            {
                string fileName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\x\Trees\tree.X");
            ...
            {
                string fileName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\x\Trees\tree1.X");
            ...
            {
                string fileName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\x\Trees\tree2.X");
