    ...
    public partial class MainForm : Form
    {
        ...
        void axRenderControl1_RcMouseClickSelect(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEvent e)
        {
            if (e.eventSender == gviMouseSelectMode.gviMouseSelectClick)
            {
                ...
                if (pr != null && pr.Type == gviObjectType.gviObjectFeatureLayer)
                {
                    ...
                    this.axRenderControl1.FeatureManager.HighlightFeature(fcuidMap[fl.FeatureClassId.ToString()] as IFeatureClass, flpr.FeatureId, 0xffff0064);
                }
                else
                {
                    return;
        ...
        private void tsb_ClearMap_Click(object sender, EventArgs e)
        {
            foreach (IFeatureLayer mylayer in layers)
            {
                ...
                Marshal.ReleaseComObject(mylayer);
            }
            layers.Clear();
