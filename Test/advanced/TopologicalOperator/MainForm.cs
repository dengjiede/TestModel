...
namespace TopologicalOperator
{
    public partial class MainForm : Form
    {
        ...
        void axRenderControl1_RcMouseClickSelect(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEvent e)
        {
            ...
            {
                if (e.pickResult.Type == gviObjectType.gviObjectFeatureLayer)
                {
                        ...
                        if (fc.Guid.Equals(fl.FeatureClassId))
                        {
                            ...
                            switch (source)
                            {
                                case SOURCE.SELECT1:
                                    ...
                                    drawLabel(e.intersectPoint, "要素一", 0xFF8000FF);
                                    break;
                                case SOURCE.SELECT2:
                                    this.axRenderControl1.FeatureManager.HighlightFeature(fc, fid, 0xff0000ff);
                                    geo2.AddGeometry(fdeRow.GetValue(nPos) as IPolygon);
                                    drawLabel(e.intersectPoint, "要素二", 0xFF0000FF);
                                    break;
                            }
        ...
        void axRenderControl1_RcObjectEditFinish(object sender, EventArgs e)
        {
            switch (source)
            {
                case SOURCE.DRAW1:
                    ...
                    drawLabel((geoEditing as IPolygon).Centroid, "要素一", 0xFF8000FF);
                    break;
                case SOURCE.DRAW2:
                    geo2.AddGeometry(geoEditing as IPolygon);
                    drawLabel((geoEditing as IPolygon).Centroid, "要素二", 0xFF0000FF);
                    break;
            }
        ...
        private void drawLabel(IPoint p, string text, UInt32 color)
        {
            ...
            tableLabel.TableBackgroundColor = 0x70D0D033;
