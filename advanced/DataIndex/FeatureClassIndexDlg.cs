    ...
    public partial class FeatureClassIndexDlg : Form
    {
        ...
        public FeatureClassIndexDlg(IFeatureClass pFc)
        {
            ...
            if (DbIndexInfos != null)
            {
                ...
                {
                    IDbIndexInfo DbIndex = DbIndexInfos[k];
            ...
            if (GridIndexInfos != null)
            {
                ...
                {
                    IGridIndexInfo GridIndex = GridIndexInfos[k] as IGridIndexInfo;
                    if (GridIndex != null)
                    {
            ...
            if (RenderIndexInfos != null)
            {
                ...
                {
                    IRenderIndexInfo RenderIndex = RenderIndexInfos[k] as IRenderIndexInfo;
                    if (RenderIndex != null)
                    {
