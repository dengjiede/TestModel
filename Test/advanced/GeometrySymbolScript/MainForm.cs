    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            // 可视化Polyline类型FeatureLayer
            {
                ...
                geoSymbol.Script = "<Color>0xffffff00</Color><Width>$(Groupid)*10</Width><ImageName>$(ImageName)</ImageName><RepeatLength>100</RepeatLength>";
                geoRender.Symbol = geoSymbol;
            ...
            // 可视化ModelPoint类型FeatureLayer
            {
                ...
                geoSymbol.Script = "<Color>0xffffff00</Color>";
