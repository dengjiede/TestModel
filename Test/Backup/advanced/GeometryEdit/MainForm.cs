...
namespace GeometryEdit
{
    public partial class MainForm : Form
    {
        ...
        private ISpatialCRS __crs = null;
        ...
        public MainForm()
        {
            ...
            try
            {
                ...
                __crs = dataset.SpatialReference;
        ...
        private void btnCreateModelPoint_Click(object sender, EventArgs e)
        {
            ...
            fde_modelpoint.SpatialCRS = __crs;
            //****获取包围盒
        ...
        private void btnCreatePoi_Click(object sender, EventArgs e)
        {
            _geoEditor.FinishEdit();   //用于当拾取到基准面时，或者没有正常右键结束连续调用Start时  
            ...
            fde_poi = (IPOI)gfactory.CreateGeometry(gviGeometryType.gviGeometryPOI,
                gviVertexAttribute.gviVertexAttributeZ);
            fde_poi.SetCoords(0, 0, 0, 0, 0);
            string tmpPngPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\png\huang.png");
            fde_poi.ImageName = tmpPngPath;
            fde_poi.Size = 15;
            fde_poi.SpatialCRS = __crs;
            rpoi = this.axRenderControl1.ObjectManager.CreateRenderPOI(fde_poi);

            resultCode = _geoEditor.StartEditRenderGeometry(rpoi, gviGeoEditType.gviGeoEditCreator);
            if (!resultCode)
                MessageBox.Show(this.axRenderControl1.GetLastError().ToString());
        }
        ...
        private void btnCreateFeature_Click(object sender, EventArgs e)
        {
            ...
            this.axRenderControl1.RcMouseClickSelect -= new Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEventHandler(axRenderControl1_RcMouseClickSelect_CreateFeature);
            this.axRenderControl1.RcMouseClickSelect += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEventHandler(axRenderControl1_RcMouseClickSelect_CreateFeature);
        }
        ...
        void axRenderControl1_RcMouseClickSelect_CreateFeature(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEvent e)
        {
            _geoEditor.FinishEdit();   //用于当拾取到基准面时，或者没有正常右键结束连续调用Start时  
            ...
            {
                switch (e.pickResult.Type)
                {
                    case gviObjectType.gviObjectFeatureLayer:
                        {
                            IFeatureLayerPickResult flpr = e.pickResult as IFeatureLayerPickResult;
                            ...
                            {
                                if (cursor != null)
                                    Marshal.ReleaseComObject(cursor);    //一定要释放COM对象
                            }

                            this.axRenderControl1.FeatureManager.HighlightFeature(_featureClass, fid, 0xffff0000);
        ...
        void axRenderControl1_RcMouseClickSelect_Edit(object sender, Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEvent e)
        {
            this.axRenderControl1.FeatureManager.UnhighlightAll();        
            ...
            if (e.pickResult != null)
            {
                switch (e.pickResult.Type)
                {
                    ...
                    case gviObjectType.gviObjectRenderModelPoint:
                        {
                            IRenderModelPointPickResult flpr = e.pickResult as IRenderModelPointPickResult;
                    ...
                    case gviObjectType.gviObjectRenderPoint:
                        {
                            IRenderPointPickResult flpr = e.pickResult as IRenderPointPickResult;
                            rpoint = flpr.Point;
                    ...
                    case gviObjectType.gviObjectRenderPOI:
                        {
                            IRenderPOIPickResult flpr = e.pickResult as IRenderPOIPickResult;
                            rpoi = flpr.POI;
                            currentGeometry = rpoi;
                            EditGeometry();
                        }
                        break;
                    case gviObjectType.gviObjectRenderPolyline:
                        {
                            IRenderPolylinePickResult flpr = e.pickResult as IRenderPolylinePickResult;
                    ...
                    case gviObjectType.gviObjectRenderPolygon:
                        {
                            IRenderPolygonPickResult flpr = e.pickResult as IRenderPolygonPickResult;
        ...
        private void cbBeginEdit_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.axRenderControl1.RcMouseClickSelect -= new Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEventHandler(axRenderControl1_RcMouseClickSelect_CreateFeature);
                this.axRenderControl1.RcMouseClickSelect += new Gvitech.CityMaker.Controls._IRenderControlEvents_RcMouseClickSelectEventHandler(axRenderControl1_RcMouseClickSelect_Edit);
                this.axRenderControl1.InteractMode = gviInteractMode.gviInteractEdit;
