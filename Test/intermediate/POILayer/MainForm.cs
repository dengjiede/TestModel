    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            try
            {
                ...
                string tmpFDBPath = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\Beijing_subway.FDB");
            ...
            htmlwindow = this.axRenderControl1.GetOcx() as IHTMLWindow;
            ...
            foreach (IFeatureClass fc in fcMap.Keys)
            {
                ...
                if (fdeRow != null)
                {
                    ...
                    if (nPos != -1 && !fdeRow.IsNull(nPos))
                    {
                        ...
                        this.axRenderControl1.FeatureManager.UnhighlightAll();
                        this.axRenderControl1.FeatureManager.HighlightFeature(curFeatureClass, int.Parse(fdeRow.GetValue(0).ToString()), 0xffff0000);

                        mp.ImageName = Path.Combine(Application.StartupPath.Substring(0, flag), @"Samples\Media\png\lan.png");
                        IRenderPOI rpoi = this.axRenderControl1.ObjectManager.CreateRenderPOI(mp);
                        rpoi.Highlight(0xff00ff00);
